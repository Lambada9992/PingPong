...
#include <memory>
#include "../../PingPong_App/network/sockethandler.h"
...
QT_MOC_LITERAL(5, 57, 19), // "messageToInterprete"
QT_MOC_LITERAL(6, 77, 7), // "message"
QT_MOC_LITERAL(7, 85, 9), // "readyRead"
QT_MOC_LITERAL(8, 95, 12) // "disconnected"

    },
    "SocketHandler\0error\0\0QTcpSocket::SocketError\0"
    "socketerror\0messageToInterprete\0message\0"
...
void SocketHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->messageToInterprete((*reinterpret_cast< QString(*)>(_a[1]))); break;
        ...
        {
            using _t = void (SocketHandler::*)(QTcpSocket::SocketError );
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&SocketHandler::messageToInterprete)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void SocketHandler::error(QTcpSocket::SocketError _t1)
{
...
// SIGNAL 1
void SocketHandler::messageToInterprete(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
